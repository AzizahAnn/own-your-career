...
<body>
    <div class="register-container">
        ...
        <form action="{{ route('perusahaan.daftar') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" id="deskripsi" placeholder="Ceritakan tentang perusahaan Anda...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                <div class="error-text">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="links">
            <p>Sudah punya akun? <a href="{{ route('perusahaan.masuk') }}">Masuk di sini</a></p>
