...
<head>
    ...
    <title>Login Admin - Own Your Career</title>
    ...
    <style>
        ...
        * {
        ...
        .login-container {
            background: white;
            border-radius: 15px; /* Konsisten dengan desain sebelumnya */
            padding: 40px;
...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <h2>Login Admin</h2>
            <p>Kelola sistem Own Your Career</p>
        </div>
        ...
        <form action="{{ route('admin.masuk') }}" method="POST">
            @csrf
